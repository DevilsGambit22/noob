(() => {
  ...
  const RADIO_TRACKS = [
    { file: "Audio.mp3", title: "Apocalypse" },
    { file: "cry.mp3", title: "Cry" },
    { file: "nothing.mp3", title: "Nothing's Gonna Hurt You Baby" }
  ];
  ...
  function loadTrack(index, autoplay = false) {
    ...
    audioPlayer.src = `assets/music/${encodeURIComponent(track.file)}`;
    audioPlayer.load();
